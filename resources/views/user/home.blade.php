...
<div class="border-y border-border py-4 overflow-hidden bg-warm-gray">
    <div class="marquee-track">
        @php
            $items = ['Giặt Sấy','·','Giao Nhanh','·','Chất Lượng Đảm Bảo','·','Tận Tâm','·','Hoàn Tiền Nếu Không Sạch','·','Hỗ Trợ 24/7','·'];
        @endphp
...
<section class="bg-warm-gray py-24">
    <div class="max-w-screen-xl mx-auto px-6 lg:px-12">
        ...
        <div class="flex flex-col items-center text-center mb-16" data-reveal>
            ...
            <h2 class="headline text-3xl lg:text-5xl font-black text-ink mb-4">Sản phẩm nổi bật</h2>
            <div class="mt-2 w-16 h-1 bg-bronze"></div>
        </div>

        @if($featuredProducts->isEmpty())
            <p class="text-center text-ink-muted py-16 text-sm">Chưa có sản phẩm nào.</p>
        @else
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 xl:gap-14">
            ...
            <div class="text-center mt-20" data-reveal>
                <a href="{{ route('shop') }}"
                   class="btn-ghost border-2 border-ink px-8 py-3 font-bold hover:bg-ink hover:text-white transition-all">
...
<section class="max-w-screen-xl mx-auto px-6 lg:px-12 py-28">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="grid grid-cols-2 gap-4" data-reveal data-delay="0.2s">
            ...
            <div class="aspect-square overflow-hidden bg-warm-gray">
                <img src="{{ $p->image_src }}" alt="{{ $p->name }}"
                     class="w-full h-full object-cover hover:scale-105 transition-transform duration-700">
            </div>
            @empty
            @for($j = 0; $j < 4; $j++)
            <div class="aspect-square bg-warm-gray flex items-center justify-center text-ink-muted text-sm">
                Hình ảnh {{ $j + 1 }}
            </div>
            @endfor
            @endforelse
...
<section class="bg-ink py-24 px-6 lg:px-12" id="contact">
    <div class="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div data-reveal>
            ...
            <h2 class="headline text-3xl font-medium text-cream mb-3">Chúng tôi lắng nghe bạn</h2>
